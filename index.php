...
<head>
	...
	<link rel="stylesheet" href="css/modules/home_content.css">   
	<link rel="stylesheet" href="css/modules/news_block.css">   
	<link rel="stylesheet" href="css/modules/home_audio.css">   
...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<?php require('modules/home_content.php'); ?>
			<?php require('modules/news_block.php'); ?>
			<?php require('modules/home_audio.php'); ?>
		</div>
	</div>
